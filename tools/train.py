        ...
        for config_path_dir in list_dir:
            ...
            for config_dir in list_config_dir:
                ...
                for stage in list_config_dir_stage:
                    ...
                    print("staring", config_stage_dir + stage + "/")
                    ...
                    if args.work_dir is not None:
                        ...
                        cfg.work_dir = osp.join('./work_dirs',
                                                osp.splitext(osp.basename(config_stage_dir + stage))[0])
                    ...
                    # dump config
                    cfg.dump(osp.join(cfg.work_dir, osp.basename(config_stage_dir + stage)))

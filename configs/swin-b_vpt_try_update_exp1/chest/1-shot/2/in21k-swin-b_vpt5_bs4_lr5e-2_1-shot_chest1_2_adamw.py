...
nshot = 1
lr = 5e-2
run_name = f'in21k-swin-b_vpt-{vpl}_bs4_lr{5e-2}_{nshot}-shot_{dataset}'
...
model = dict(
    ...
    neck=None,
    head=dict(
        type='MultiLabelLinearClsHead_merge', num_classes=19, in_channels=1024))
...
load_from = f'work_dirs/chest/{nshot}-shot/exp{5}/{run_name}/best.pth'
